      ...
      builder: (context) => Dialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("🎓 ${"dentalMasterGraduate".tr()} 🎓", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.orange)),
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        SingleChildScrollView(child: Column(children: [
          if (widget.lesson.category.toLowerCase().contains("video") && yt != null) YoutubePlayer(controller: yt!) else Image.asset(widget.lesson.image, height: 250, fit: BoxFit.cover),
